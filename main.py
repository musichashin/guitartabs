...
def index():
    ...
    <head>
        ...
        <style>
            ...
            #alphaTab {
                ...
                overflow-y: auto;
                position: relative;
                /* Важно для корректной работы выделения мышкой */
                user-select: none;
    ...
    <body>
        ...
        <div class="controls">
            <!-- Файл -->
            <button onclick="document.getElementById('fileInput').click()" title="Открыть файл">📂</button>
            ...
            <div class="tempo-group">
                ...
                <button id="resetTempo" style="padding: 4px 8px;" title="Сброс">↺</button>
            </div>

            <!-- Loop -->
            <button id="loopButton" title="Зациклить">🔁</button>
            
            <!-- Дорожки -->
            <select id="trackList" style="display:none"></select>

            <!-- Плей -->
            <button id="playPause" style="min-width: 50px;">▶</button>
        </div>
        ...
        <script>
            ...
            api.playerStateChanged.on((args) => {
                playButton.innerText = args.state === 1 ? '⏸' : '▶';
            });
            ...
            api.scoreLoaded.on((score) => {
                ...
                // Показываем список только если дорожек больше одной
